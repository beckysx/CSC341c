/*
 ...
 Program description:
 This program will take a sequence of integers as input, and when the program terminates,
 it will out put the integers in increasing order, one per line, and each distinct integer
 printed just once. Afterward, programs should print "REPEAT" there are repeated values and
 "NO REPEATS" otherwise.
